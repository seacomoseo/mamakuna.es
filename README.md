...
- If new project (not fork):
  - Copy [mamakuna.es project files](https://github.com/mamakuna/mamakuna.es)
...
- `README.md` ⏩ edit baseURL ("mamakuna.es") + delete steps bit by bit
- Design
...
- If Netlify
  - [`Domain Management / settings`](https://app.netlify.com/sites/mamakuna/settings/domain)
  - `Add custom domain`
...
- If Cloudflare Pages
  - [Custom domains](https://dash.cloudflare.com/?to=/:account/pages/view/mamakuna/domains)
  - `Set up a custom domains`
  - `mamakuna.es`
  - `Continue`
  - `Activate domain` (if `Begin DNS transfer` end)
  - Repeat with `www.mamakuna.es`
  - ...........................................................
...
- If Netlify Form
  ...
  - [`Netlify ⏩ Site ⏩ Forms ⏩ Form Notifications`](https://app.netlify.com/sites/mamakuna/settings/forms#form-notifications) ⏩ `Add notification ⏩ Email notification ⏩ Email to Notify`
    - `Email to notify` = Emails of collaborators that want receive submissions
    - `Custom email subject line` = `Formulario de contacto de mamakuna.es`
    - `Save`
  - Submissions: [`Netlify site ⏩ Forms`](https://app.netlify.com/sites/mamakuna/forms)
...
1. [Servicios mamakuna.es](https://drive.google.com/file/d/1trq28fMfEVwoZOk4ue0tJzAJDZtj64BK) ⏩ `File ⏩ Make a copy` ⏩ Select client directory.
1. Change the info.
